...
*/
vk::DescriptorSetLayout vkInit::CreateDescriptorSetLayout(vk::Device device, const DescriptorSetLayoutData& bindings)
{
...
vk::DescriptorPool vkInit::CreateDescriptorPool(vk::Device device, uint32_t size, const DescriptorSetLayoutData& bindings)
{
...
vk::DescriptorSet vkInit::AllocateDescriptorSet(vk::Device device, vk::DescriptorPool descriptorPool, vk::DescriptorSetLayout layout)
{
